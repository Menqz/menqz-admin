...
class UninstallCommand extends Command
{
    ...
    {
        if (!$this->confirm('Are you sure to uninstall menqz-admin?')) {
            return;
        }

        $this->removeFilesAndDirectories();

        $this->line('<info>Uninstalling menqz-admin!</info>');
    }
    ...
    protected function removeFilesAndDirectories()
    {
        ...
        $this->laravel['files']->deleteDirectory(public_path('vendor/menqz-admin/'));
