...
use MenqzAdmin\Admin\Form as ModalForm;
...
class Form extends Interactor
{
    ...
    {
        if ($this->extendsFrom($this->action, 'MenqzAdmin\Admin\Actions\RowAction')) {
    ...
    protected function checkUploadFiel($field)
    {
        ...
        if ($this->extendsFrom($field, 'MenqzAdmin\Admin\Form\Field\File')) {
            $this->multipart = true;
        }
    }
