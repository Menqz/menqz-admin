...
class Admin
{
    ...
    /**
     * Returns the long version of menqz-admin.
     *
     * @return string The long application version
     */
    public static function getLongVersion()
    {
        return sprintf('menqz-admin <comment>version</comment> <info>%s</info>', self::VERSION);
    }
     ...
     * Get navbar object.
     *
     * @return \MenqzAdmin\Admin\Widgets\Navbar
     */
    ...
    /**
     * Register the menqz-admin builtin routes.
     *
     * @return void
     *
    ...
    public function routes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('\MenqzAdmin\Admin\Controllers')->group(function ($router) {
    ...
    {
        return url('/vendor/menqz-admin/'.$asset);
    }
