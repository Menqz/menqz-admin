...
class NestedForm
{
    ...
    /**
     * @var \MenqzAdmin\Admin\Form|\MenqzAdmin\Admin\Widgets\Form
     */
    protected $form;
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if (($field instanceof \MenqzAdmin\Admin\Form\Field\Hidden) || $value != $field->original() || ($this->save_null_values && $value == null)) {
                if (is_array($columns)) {
