...
trait HasMediaPicker
{
    ...
    {
        if (!class_exists("MenqzAdmin\Admin\Media\MediaManager")) {
            throw new \Exception(
                '[Media Manager extention not installed yet.<br> Install using: <b>composer require menqz-admin-ext/media-manager</b><br><br>'
            );
        }
