...
class Map extends Field
{
    ...
    public static function getAssets()
    {
        switch (config('admin.map_provider')) {
            ...
            case 'openstreetmaps':
            default:
                $css = ['/vendor/menqz-admin/leaflet/leaflet.css', '/vendor/menqz-admin/leaflet/leaflet-geosearch.css'];
                $js = ['/vendor/menqz-admin/leaflet/leaflet.js', '/vendor/menqz-admin/leaflet/leaflet-geosearch.js'];
        }
