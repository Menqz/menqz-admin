...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \MenqzAdmin\Admin\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('MenqzAdmin\Admin\AdminServiceProvider');
    ...
    protected function setUp(): void
    {
        ...
        $this->artisan('vendor:publish', ['--provider' => 'MenqzAdmin\Admin\AdminServiceProvider']);
...
//        \MenqzAdmin\Admin\Admin::$css = [];
//        \MenqzAdmin\Admin\Admin::$js = [];
//        \MenqzAdmin\Admin\Admin::$script = [];
    }
